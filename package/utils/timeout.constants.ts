 ...
 */
export const BIG_TIMEOUT = 15 * 1000;

/**
 * Maximum timeout constant, set to 60000 milliseconds (1 minute).
 */
export const MAX_TIMEOUT = 15 * 1000;
 ...
 */
export const NAVIGATION_TIMEOUT = 15 * 1000;

/**
 * Timeout constant for Playwright's test functions, set to 300000 milliseconds (30 seconds).
 */
export const TEST_TIMEOUT = 15 * 1000;
